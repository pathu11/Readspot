...
//         // $data = $_SESSION['purchase_data'] ?? null;
//         // var_dump($_SESSION);
//         $data = $_GET;
//         $user_id = $_SESSION['user_id'];
//         $customerDetails = $this->customerModel->findCustomerById($user_id);       
...
//                 $this->handleCardPaymentForm($data,$formType);

//             } elseif ($formType === 'onlineDeposit') {
               
//                 $this->handleOnlineDepositForm($data,$formType);
//             }elseif ($formType === 'COD') {
                
//                 $this->handleCODForm($data,$formType);
//             }
...
//     }
// }
// private function handleCardPaymentForm($data, $formType)
// {
//     $orderDetails=$this->ordersModel->getOrderById($order_id);
...
// private function handleCODForm($data,$formType){
...
// }
// private function handleOnlineDepositForm($data, $formType)
// {
//     // $user_id = $_SESSION['user_id'];
//     // $customerDetails = $this->customerModel->findCustomerById($user_id);
//     // $customer_id = $customerDetails[0]->customer_id;
...
//     // Make sure errors are empty
//     if ($this->customerModel->addOrder($data) && $data['recipt']) {
//          $trackingNumber = $this->generateUniqueTrackingNumber($order_id);
...
//                 // if($this->customerModel->addOrder($data)){
//                 //     $orderId = $this->customerModel-> getLastInsertedOrderId();
//                     redirect('customer/checkout2/'.$queryString);
//                 // }else{
//                 //   echo  '<script>alert("Error")</script>';
//                 // }
