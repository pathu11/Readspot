...
<tbody>
    ...
    <tr>
        ...
        <td class="action">
            <a href='#'onclick='confirmDelete(<?php echo $customer->user_id; ?>)' ><i class='fa fa-user-times'  title="Remove this user from the website"></i></a>
            <a href='#'onclick='confirmRestrict(<?php echo $customer->user_id; ?>)' ><i class='fa fa-ban'  title="Restrict this account for 7 days" ></i></a>
            <a href="<?php echo URLROOT; ?>/Chats/chat/<?php echo $customer->user_id; ?>"><i class='fas fa-comment-dots'  title="Chat with this user" ></i></a>   
    </td>
    </tr>
<?php endforeach; ?>   
<tbody>            
        ...
        <div id="confirmationRestrict" class="confirmationModal1">
            <div class="confirmation-content1">
                ...
                <h2>Confirmation</h2>
                <p>Are you sure you want to restrict  this customer for 7 days?</p>
                <button onclick="proceedRestrict(<?php echo $customer->user_id; ?>)">Yes</button>
...
function proceedRestrict(userId) {
    window.location.href = '<?php echo URLROOT; ?>/superadmin/restrictcustomers/' + userId;
}
