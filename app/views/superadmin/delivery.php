...
<tbody>
    ...
    <tr>
        ...
        <td>
            <a href='<?php echo URLROOT; ?>/superadmin/updateDelivery/<?php echo $delivery->user_id; ?>'><i class='fa fa-edit' style='color:#09514C;'></i></a>

            <a href='#'onclick='confirmDelete(<?php echo $delivery->user_id; ?>)' ><i class='fa fa-trash' style='color:#09514C;'></i></a>
    </td>
