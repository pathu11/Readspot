...
<tbody>
    ...
    <tr>
        ...
        <td class="action">
            <a href='#'onclick='confirmDelete(<?php echo $charity->user_id; ?>)' ><i class='fa fa-user-times'  title="Remove this user from the website"></i></a>
            <a href='#'onclick='confirmRestrict(<?php echo $charity->user_id; ?>)' ><i class='fa fa-ban'  title="Restrict this account for 7 days" ></i></a>
            <a href="<?php echo URLROOT; ?>/Chats/chat/<?php echo $charity->user_id; ?>"><i class='fas fa-comment-dots'  title="Chat with this user" ></i></a>
    </td>
...
<tbody>            
        ...
        <div id="confirmationDelete" class="confirmationModal">
            <div class="confirmation-content">
                ...
                <button onclick="proceedDelete(<?php echo $charity->user_id; ?>)">Yes</button>
