...
<tbody>
    ...
    <tr>
        ...
        <td class="action">
            <a  href='<?php echo URLROOT; ?>/superadmin/updateAdmin/<?php echo $admin->user_id; ?>'><i class='fa fa-edit'  ' title="Edit Admin Details"></i></a>

            <a href='#'onclick='confirmDelete(<?php echo $admin->user_id; ?>)' ><i class='fa fa-user-times' title="Remove this user from the website"></i></a>
            <a  href='#'onclick='confirmRestrict(<?php echo $admin->user_id; ?>)' ><i class='fa fa-ban' title="Restrict this account for 7 days" ></i></a>

           <a  href="<?php echo URLROOT; ?>/Chats/chat/<?php echo $admin->user_id; ?>"><i class='fas fa-comment-dots'  title="Chat with this user" ></i></a>
    </td>
...
<tbody>            
        ...
        <div id="confirmationDelete" class="confirmationModal">
            <div class="confirmation-content">
                ...
                <button onclick="proceedDelete(<?php echo $admin->user_id; ?>)">Yes</button>
        ...
        <div id="confirmationRestrict" class="confirmationModal1">
            <div class="confirmation-content1">
                ...
                <h2>Confirmation</h2>
                <p>Are you sure you want to restrict  this admin for 7 days?</p>
                <button onclick="proceedRestrict(<?php echo $admin->user_id; ?>)">Yes</button>
        ...
        <div class="button-container">
            <a href="<?php echo URLROOT; ?>/superadmin/addAdmin"><button>Add</button></a>
...
function proceedRestrict(userId) {
    window.location.href = '<?php echo URLROOT; ?>/superadmin/restrictadmins/' + userId;
}
    ...
    function proceedDelete(userId) {
        window.location.href = '<?php echo URLROOT; ?>/superadmin/deleteadmins/' + userId;
    }
</script>
