...
?>
    ...
    <div class="container">
        <div class="add-content">
            ...
            <form action="<?php echo  URLROOT; ?>/customer/updateContent/<?php echo $data['id']; ?>"  method="POST" enctype="multipart/form-data" class="cont-add">
                ...
                <div class="disc-cont">
                    ...
                    <textarea id="description" name="description" rows="12" class="form-topic" required><?php echo $data['Description']; ?></textarea>
                </div>
