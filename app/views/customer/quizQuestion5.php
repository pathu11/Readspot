...
<body>
  ...
  <div class="img-options">
    ...
    <div class="options">
    <form id="quizForm" action="<?php echo URLROOT; ?>/customer/quizQuestion5/<?php echo $data['quiz_id']; ?>" method="post">
        <div class="container">
        ...
        <div class="next">
          <button type="submit"><strong>Finish</strong><i class="fa fa-solid fa-forward fa-lg"></i></button>
        </div>
      </form>
    </div>
  </div>
