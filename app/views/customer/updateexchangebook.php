...
?>
    ...
    <div class="container">
        <div class="add-content">
            ...
            <form action="<?php echo URLROOT; ?>/customer/updateexchangebook/<?php echo $data['book_id'];?>" enctype="multipart/form-data" class="book-add" method="POST" onsubmit="return validateISBN()">
