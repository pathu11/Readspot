...
<body>
  <div class="question">
    <p style="color:#0B5E70"><strong>Question 03</strong></p>
  ...
  <div class="img-options">
    ...
    <div class="options">
      <form id="quizForm" action="<?php echo URLROOT; ?>/customer/quizQuestion/<?php echo $data['quiz_id']; ?>/3" method="post" onsubmit="handleSubmit()">
        <div class="container">
        ...
        <div class="next">
          <button type="submit"><strong>Question 04</strong><i class="fa fa-solid fa-forward fa-lg"></i></button>
        </div>
      </form>
    </div>
  </div>
