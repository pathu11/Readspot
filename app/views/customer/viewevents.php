...
?>
    ...
    <div class="event-details">
        ...
        <div class="event-btn-div">
            <?php if($data['eventInCalendar']): ?>
                <a href="<?php echo URLROOT; ?>/customer/RemoveEventFromCalender/<?php echo $data['eventId'];?>">
                    <button id="removeBtn" class="event-chat-btn">Remove from Calendar</button>
                </a>
            <?php else: ?>
                <a href="<?php echo URLROOT; ?>/customer/AddEventToCalender/<?php echo $data['eventId'];?>">
                    <button id="addBtn" class="event-chat-btn">Add to Calendar</button>
                </a>
            <?php endif; ?>
        </div>
